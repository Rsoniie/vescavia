...
const webServices = [
  {
    ...
    description: 'Unique, responsive designs that reflect your brand and engage users.'
  },
  {
...
const processSteps = [
  ...
  {
    title: 'Launch',
    description: 'We deploy, monitor, and support your site for long-term success.'
  },
];
...
const testimonials = [
  {
    name: 'Ava Chen',
    company: 'FreshMart',
    quote: 'Our new website is fast, beautiful, and converts like crazy. Thank you, Vescavia!'
  },
  {
    name: 'Liam O’Connor',
    company: 'Peak Fitness',
    quote: 'The e-commerce solution was seamless and boosted our sales instantly.'
  },
  {
    name: 'Sara Kim',
    company: 'TechBridge',
    quote: 'The web app is robust, scalable, and a joy to use. Highly recommend Vescavia.'
  },
];
...
const faqs = [
  {
    ...
    answer: 'We build on all major platforms including custom stacks, Shopify, WordPress, and more.'
  },
  {
    question: 'How long does a website project take?',
    answer: 'Most sites launch in 4-8 weeks, depending on complexity and features.'
  },
  {
...
export default function WebDevelopmentPage() {
  return (
    <div className="min-h-screen bg-[#11001D] text-white w-full">
      <SEO title="Web Development Services" description="Vescavia: Modern web development for brands that want to win online." />
      <Navbar />
      {/* Hero Section */}
      <section className="relative flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto pt-32 pb-16 px-4 sm:px-8">
        <div className="flex-1 z-10 text-left">
          ...
          <p className="text-lg md:text-2xl text-gray-200 max-w-xl mb-8">
            We build <span className="text-fuchsia-300 font-bold">modern</span>, <span className="text-blue-300 font-bold">high-converting</span> websites and apps for ambitious brands.
          </p>
        ...
        <div className="bg-gradient-to-br from-purple-900/60 via-fuchsia-900/60 to-blue-900/60 rounded-3xl p-8 md:p-12 shadow-2xl border border-fuchsia-400/20 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            ...
            <p className="text-gray-200 text-lg mb-4">
              We don’t just build websites. We create <span className="text-fuchsia-300 font-semibold">experiences</span> that engage, convert, and grow your business.
            </p>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="relative w-64 h-64 rounded-2xl overflow-hidden shadow-xl border-2 border-fuchsia-400/30">
              <Image src="/images/services/web-hero.jpg" alt="Web Development Visual" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl border border-fuchsia-400/10 bg-gradient-to-br from-purple-900/40 via-fuchsia-900/40 to-blue-900/40">
          ...
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-lg text-gray-200 max-w-xl text-center">
              Your site could be here! We turn ideas into high-performing web experiences.
            </p>
          </div>
        </div>
      </section>
