...
const adServices = [
  {
    ...
    description: 'Scroll-stopping video ads crafted for every platform. From concept to viral delivery.'
  },
  {
    image: '/images/services/ad-creative-2.jpg',
    title: 'Social Media Campaigns',
    description: 'Creative, thumb-stopping ads for Instagram, TikTok, Facebook, and more.'
  },
  {
    image: '/images/services/ad-creative-3.jpg',
    title: 'Copywriting & Scripting',
    description: 'Words that sell. Scripts and copy that turn browsers into buyers.'
  },
  {
...
const processSteps = [
  {
    title: 'Discovery',
    description: 'We dive deep into your brand, audience, and goals to spark the big idea.'
  },
  {
    title: 'Creative Concept',
    description: 'Our team brainstorms, storyboards, and pitches bold ad concepts tailored for your brand.'
  },
  {
    title: 'Production',
    description: 'From script to screen, we bring your ad to life with top-tier visuals and sound.'
  },
  {
...
const testimonials = [
  {
    ...
    quote: 'Vescavia took our ad game to the next level. Our campaign went viral and sales skyrocketed!'
  },
  {
    name: 'Priya Singh',
    company: 'FitFuel',
    quote: 'The creative team at Vescavia just gets it. Our brand has never looked better online.'
  },
  {
    name: 'Jordan Lee',
    company: 'TechNest',
    quote: 'From concept to launch, the process was seamless and the results were outstanding.'
  },
];
...
const faqs = [
  {
    ...
    answer: 'We create ads for all major platforms including Instagram, TikTok, Facebook, YouTube, and more.'
  },
  {
    question: 'How long does the ad creation process take?',
    answer: 'Most projects take 2-4 weeks from kickoff to delivery, depending on complexity.'
  },
  {
    question: 'Can you help with ad strategy and placement?',
    answer: 'Absolutely! We offer full-funnel creative strategy and can advise on media buying and placement.'
  },
];
...
export default function AddCreationPage() {
  return (
    <div className="min-h-screen bg-[#11001D] text-white w-full">
      <SEO title="Ad Creation Services" description="Vescavia: Ad Creation that Converts. Viral, bold, and unforgettable." />
      <Navbar />
      {/* Hero Section */}
      <section className="relative flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto pt-32 pb-16 px-4 sm:px-8">
        <div className="flex-1 z-10 text-left">
          ...
          <p className="text-lg md:text-2xl text-gray-200 max-w-xl mb-8">
            From concept to viral campaign, we craft ads that <span className="text-fuchsia-300 font-bold">convert</span> and <span className="text-blue-300 font-bold">captivate</span>.
          </p>
        ...
        <div className="bg-gradient-to-br from-purple-900/60 via-fuchsia-900/60 to-blue-900/60 rounded-3xl p-8 md:p-12 shadow-2xl border border-fuchsia-400/20 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            ...
            <p className="text-gray-200 text-lg mb-4">
              We don’t just make ads. We create <span className="text-fuchsia-300 font-semibold">experiences</span> that stick, stories that spread, and campaigns that <span className="text-blue-300 font-semibold">convert</span>.
            </p>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="relative w-64 h-64 rounded-2xl overflow-hidden shadow-xl border-2 border-fuchsia-400/30">
              <Image src="/images/services/ad-hero.jpg" alt="Ad Creation Visual" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl border border-fuchsia-400/10 bg-gradient-to-br from-purple-900/40 via-fuchsia-900/40 to-blue-900/40">
          ...
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-lg text-gray-200 max-w-xl text-center">
              Your ad could be here! We turn ideas into scroll-stopping visuals and viral moments.
            </p>
          </div>
        </div>
      </section>
