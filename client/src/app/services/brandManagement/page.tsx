...
const brandServices = [
  {
    ...
    description: 'Crafting a unique brand identity and positioning for maximum impact.'
  },
  {
  ...
  },
  {
    ...
    description: 'Logos, color palettes, and assets that make your brand unforgettable.'
  },
  {
...
const processSteps = [
  ...
  {
    title: 'Design',
    description: 'We bring your brand to life with stunning visuals and messaging.'
  },
  {
    title: 'Launch',
    description: 'We roll out your new brand identity and ensure a seamless transition.'
  },
];
...
const testimonials = [
  {
    name: 'Morgan Taylor',
    company: 'EcoWave',
    quote: 'Vescavia transformed our brand. We finally stand out in a crowded market!'
  },
  {
    name: 'Samira Patel',
    company: 'Urban Roots',
    quote: 'The new brand identity is bold, modern, and exactly what we needed.'
  },
  {
    name: 'Chris Evans',
...
const faqs = [
  {
    ...
    answer: 'Brand management is the process of building, maintaining, and evolving your brand’s identity and reputation.'
  },
  {
    question: 'How long does a rebrand take?',
    answer: 'A typical rebrand project takes 4-8 weeks, depending on scope and deliverables.'
  },
  {
    question: 'Can you help with ongoing brand support?',
    answer: 'Yes! We offer ongoing brand management and creative support packages.'
  },
];
...
export default function BrandManagementPage() {
  return (
    <div className="min-h-screen bg-[#11001D] text-white w-full">
      <SEO title="Brand Management Services" description="Vescavia: Bold brand management for modern businesses." />
      <Navbar />
      {/* Hero Section */}
      <section className="relative flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto pt-32 pb-16 px-4 sm:px-8">
        <div className="flex-1 z-10 text-left">
          ...
          <p className="text-lg md:text-2xl text-gray-200 max-w-xl mb-8">
            We build, elevate, and protect brands that <span className="text-fuchsia-300 font-bold">stand out</span> and <span className="text-blue-300 font-bold">endure</span>.
          </p>
        ...
        <div className="bg-gradient-to-br from-purple-900/60 via-fuchsia-900/60 to-blue-900/60 rounded-3xl p-8 md:p-12 shadow-2xl border border-fuchsia-400/20 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            ...
            <p className="text-gray-200 text-lg mb-4">
              We don’t just manage brands. We create <span className="text-fuchsia-300 font-semibold">icons</span> that inspire loyalty and drive growth.
            </p>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="relative w-64 h-64 rounded-2xl overflow-hidden shadow-xl border-2 border-fuchsia-400/30">
              <Image src="/images/services/brand-hero.jpg" alt="Brand Management Visual" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
