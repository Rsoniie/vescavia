...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#11001D] px-8 py-6 flex justify-between items-center">
      <div className={`text-white text-2xl font-bold ${jaro.variable} font-sans`}>
        Vescavia
      </div>
      <div className="hidden md:flex space-x-8">
        <a href="#" className="font-medium text-white hover:text-gray-300">About</a>
        <a href="#" className="font-medium text-white hover:text-gray-300">Work</a>
        <a href="#" className="font-medium text-white hover:text-gray-300">Services</a>
