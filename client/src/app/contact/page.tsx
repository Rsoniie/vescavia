    ...
    <div className="min-h-screen bg-[#11001D] py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h1
            className={`mb-6 font-bold ${jaro.variable} text-white`}
            style={{ fontSize: '4.5rem' }}
          >
            Ready to Scale Your Brand?
          </h1>
          <p
            className={`text-white/80 ${inter.variable} font-sans mb-12`}
        ...
        <div className="flex flex-col md:flex-row gap-8 items-stretch">
          ...
          <div className="w-full md:w-2/3 bg-[#1a012a] rounded-xl p-8 border border-white/10">
            <ContactForm />
          </div>
        </div>
      </div>
