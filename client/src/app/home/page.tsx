...
export default function Home() {
  return (
    <>
      <div
        className={`min-h-screen flex flex-col bg-[#11001D] text-white ${inter.variable} font-sans`}
      >
      ...
      <div className="w-full -mt-10 z-50 pt-0">
        <MarqueeBanner
          messages={[
            'Special promotion',
      ...
      <div className="w-full z-50 pt-0">
        <MarqueeBanner
          messages={[
            'Special promotion',
            'New features available',
